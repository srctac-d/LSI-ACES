...
1. SITE PREPARATION & HEAVY MOBILITY ASSETS
...
Cable-Drawn Yarder, Harmonic Cable Vibration & $H_2$ Gas Seal Protection:
...
$H_2$ Gas Barrier Seals: All winch bearing races, rotary seals, and actuator housings utilize a low-pressure Hydrogen ($H_2$) gas charge bleed ($+0.1\text{ to }+0.5\text{ PSI}$) supplied from ISRU volatile storage. This outward gas barrier prevents backside dust migration into internal mechanical packings under hard vacuum.
...
Positive-Pressure Seal Gas Purge: Active Hydrogen ($H_2$) volatile gas micro-charge routed through rotary joints, suit-ports, and sheave assemblies to create an outward gas boundary layer against micron dust intrusion.
